<template>
    ...
    <div class="main" :style="`padding-left: ${width}px;`">
      ...
      <div class="w-100">
        ...
        <section class="d-lg-flex banner hp-banner">
          <div class="col p-0 d-flex align-items-center justify-content-center img-center">
            <div class="px-lg-5 p-4">
              <img src="/20230522-fn-org-en.png" style="width:100%; height: auto;" v-if="$i18n.locale==='en'"/>
			  <img src="/20230522-fn-org-th.png" style="width:100%; height: auto;" v-if="$i18n.locale==='th'"/>
            </div>
          </div>
        </section>
      </div>
