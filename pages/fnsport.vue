    ...
    <div class="main" :style="`padding-left: ${width}px;`">
      ...
      <div class="w-100">
        ...
        <div class="col p-0 bg-primary">
          ...
          <p class="text-white p-5">{{ $t("FN SPORT เราคัดสรรเครื่องแต่งกายกีฬาแบรนด์ระดับชั้นนำ ที่มีฟีเจอร์และเทคโนโลยีทันสมัย ทั้งเสื้อ กางเกงรองเท้าวิ่ง กระเป๋าสะพายรูปแบบต่างๆ คัดสรรสินค้าทั้งคอลเลคชั่นใหม่และสินค้าที่มีความต้องการสูง เพื่อความสะดวกในการเลือกซื้อสินค้าที่มีคุณภาพ ในราคาที่เอื้อมถึง  และสามารถตอบโจทย์การใช้ชีวิตได้ในทุกๆวัน") }}</p>
        </div>
        <div class="col d-flex align-items-center justify-content-center ">
          <div class="p-15 d-flex align-items-center justify-content-center">
            <img src="/sport-text.png" class="img-fluid" />
          </div>
        </div>
      </section>
      </div>
