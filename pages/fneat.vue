    ...
    <div class="main" :style="`padding-left: ${width}px;`">
      ...
      <div class="w-100">
        ...
        <div class="col p-0 bg-primary">
          ...
          <p class="text-white p-5">{{ $t("สวรรค์ของคนรักขนม FN EAT นำเสนอของว่างแสนอร่อยที่จะทำให้คุณเพลิดเพลินไปกับรสชาติแสนเลิศ และเครื่องดื่มมากมาย หลากหลายประเภท ที่เราตั้งใจจัดจำหน่ายด้วยความใส่ใจ รวมถึงสินค้าจากท้องถิ่นที่ FN ร่วมสนับสนุนในพื้นที่ รวบรวมไว้เพื่อความสะดวกสบายของลูกค้าที่มาจับจ่ายซื้อสินค้าเพื่อเป็นของฝาก") }}</p>
        </div>
        <div class="col d-flex align-items-center justify-content-center ">
          <div class="p-15 d-flex align-items-center justify-content-center">
            <img src="/eat-text.png" class="img-fluid" />
          </div>
        </div>
      </section>
      </div>
