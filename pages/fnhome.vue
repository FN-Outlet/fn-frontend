<template>
    ...
    <div class="main" :style="`padding-left: ${width}px;`">
      ...
      <div class="w-100">
        <section class="bg-primary d-lg-flex banner hp-banner">
          ...
          <div class="col">
            <img src="/home-banner.jpg" class="img-fluid w-100" />
          </div>
        ...
        <div class="col p-0 bg-primary">
          ...
          <p class="text-white p-5">{{ $t("แต่งบ้านของคุณด้วยความสนุกสนานกับ FN HOME เฟอร์นิเจอร์ที่ถูกออกแบบมาตอบรับกับทุกรสนิยม มาพร้อมกับความทันสมัย ความเรียบง่าย และความคลาสสิก ที่จะสามารถเปลี่ยนบ้านของคุณให้เป็นดั่งบ้านในฝันอย่างสมบูรณ์แบบ") }}</p>
        </div>
        <div class="col d-flex align-items-center justify-content-center ">
          <div class="p-15 d-flex align-items-center justify-content-center">
            <img src="/home-text.png" class="img-fluid" />
          </div>
        </div>
      </section>
      </div>
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      async getProduct() {
        const { data } = await $fetch(`/api/products?filters[type][$eq]=home&sort=id:asc&populate=*`);
        this.product = data;
